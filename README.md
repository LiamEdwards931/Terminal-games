...
- [stack-overflow](https://stackoverflow.com/) was also used to help create the leaderboard and code for clearing terminal.
- Used the love-sandwiches video for a refresher on how to deploy the app to Heroku
